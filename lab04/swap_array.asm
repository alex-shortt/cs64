...
doSwap:
  # TO`DO: translate the following C code into MIPS
  # assembly here.
  ...
  li $t1, 8 #y
  li $t2, 4 #check
  la $t3, myArray #array address start
  ...
  loop:
    ...
    sll $v0, $t0, 2 #mult x by 4
    sll $v1, $t1, 2 #mult y by 4

    addu $v0, $t3, $v0 #array address x
    addu $v1, $t3, $v1 #array address y

    lw $t4, 0($v0) #value of array at address x
    lw $t5, 0($v1) #value of array at address y
